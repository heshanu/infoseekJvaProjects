...
public class ComponentMappingClient {
	public static void main(String[] args) {
		...
		try {
			...
			// Person having 2 Address (homeAddress and billingAddress) using
			// AttributeOverrides
			/*
			 * Address homeAddress = new Address("200 E Main St", "Seattle", "85123");
			 * Address billingAddress = new Address("2751  Sigley Road", "Charlotte",
			 * "28273"); Person person = new Person("Ruby", homeAddress, billingAddress);
			 * 
			 * session.save(person);
			 */
			txn.commit();
